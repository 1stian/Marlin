...
#define STRING_CONFIG_H_AUTHOR "Stian Tofte" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 V2 SKR E3 Turbo"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -12, 1.65 }
